...
@Configuration
@EnableJpaRepositories("io.github.awuliu.jhipster.app.micro.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.github.awuliu.jhipster.app.micro.repository.search")
